...
export const testimonial_two_data = [
  {
    ...
    rating: 5,
    testimonial:
      "I need to get a certification for English proficiency and Grandcrest is my best choice. Their tutors are smart and professional when dealing with students. I wanted to place a review since! Thanks and 5 stars!",
  },
  {
    id: 2,
    name: "Annette",
