          ...
          <div className="col-12">
            ...
            >
              <h2 className="tp-about-4-head">
                Our goal is to develop and meet the needs of each child so that
                he or she becomes a well-rounded tomorrow individual.
              </h2>
              <div className="tp-about-4-btn wow fadeInUp" data-wow-delay=".5s">
                <Link className="tp-btn-3" href="/university-about">
