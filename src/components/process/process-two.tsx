...
const applicationProcess = [
  {
    ...
    description: `The University of Grandcrest uses Apply web for the processing of graduate applications. <br> Proceed to the link below to create an Apply web account, submit an application review a <br> submitted application, and access post-submission functionality.`,
