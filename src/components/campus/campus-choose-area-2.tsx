        ...
        <div className="row">
          <div className="col-lg-12">
            <div className="tp-campus-choose-wrapper text-center">
              <div
                className="tp-campus-choose-btn wow fadeInUp"
                data-wow-delay=".3s"
              >
              ...
              >
                <h2 className="tp-campus-choose-title">
                  Our goal is to develop and meet the needs <br /> of each child
                  so that he or she becomes a <br /> well-rounded tomorrow
                  individual.
                </h2>
                <Link className="tp-btn" href="/university-about">
                  Why Choose Grandcrest{" "}
                </Link>
              </div>
            </div>
          </div>
          <div className="col-lg-3 col-md-6">
            <div
              className="tp-campus-choose-thumb text-center mb-30 wow fadeInUp"
              data-wow-delay=".3s"
            >
              <Image
                src={campus_thumb_1}
          ...
          <div className="col-lg-6 col-md-6">
            <div
              className="tp-campus-choose-thumb-main text-center pt-100 mb-30 wow fadeInUp"
              data-wow-delay=".5s"
            >
              <Image
                src={campus_thumb_2}
