        ...
        <div className="row">
          <div className="col-lg-6">
            <div
              ...
              data-wow-delay=".3s"
            >
              <h3 className="tp-admission-overview-title">Afford Grandcrest</h3>
            </div>
          </div>
          <div className="col-lg-6">
            <div
            ...
            >
              <p>
                At Grandcrest University, we prepare you to launch your career
                by providing a supportive, creative, and professional
                environment from which to learn practical skills, build a
                network of industry contacts.
              </p>
              <p>
                Grandcrest is affordable for all admitted students. Financial
