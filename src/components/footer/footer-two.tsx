              ...
              <div className="col-xl-3 col-lg-4 col-md-6">
                <div className="tp-footer-widget tp-footer-2-col-1 mb-30">
                  ...
                  <div className="tp-footer-widget-content">
                    <p>
                      Grandcrest education theme, built specifically for the
                      education centers which is teaching and involve learners.
                    </p>
                  </div>
                  <div className="tp-footer-contact">
                    <div className="tp-footer-btn">
                      <Link className="tp-btn-round" href="/contact">
                        Contact Us
                        <span>
                          <RightArrowFour />
                        </span>
              ...
              <div className="col-xl-3 col-lg-4 col-md-6">
                <div className="p-footer-widget tp-footer-2-col-4 mb-30">
                  ...
                  <div className="tp-footer-contact">
                    ...
                    <a href="tel:012345678">+1234567890</a>
                  </div>
            ...
            <div className="row align-items-center">
              ...
              <div className="col-lg-6 col-md-5">
                <div className="tp-footer-copyright text-start text-md-center">
                  <span>
                    © {new Date().getFullYear()} <a href="#">Grandcrest</a>. All
                    rights reserved.
                  </span>
                </div>
              </div>
